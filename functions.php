...
function starting_theme_setup() {
	...
	add_image_size( 'hero', 1600, 960, array( 'center', 'center' ) );
	add_image_size( 'large-square', 960, 960, array( 'center', 'center' ) );
	add_image_size( 'medium-square', 420, 420, array( 'center', 'center' ) );
	...
	register_nav_menus( array(
		...
		'slider-nav-1' => esc_html__( 'Home', 'starting-theme' ),
		'slider-nav-2' => esc_html__( 'Projects', 'starting-theme' ),
		'slider-nav-3' => esc_html__( 'Services', 'starting-theme' ),
		'slider-nav-4' => esc_html__( 'About', 'starting-theme' ),
		'slider-nav-5' => esc_html__( 'News', 'starting-theme' ),
		'slider-nav-6' => esc_html__( 'Contact', 'starting-theme' ),
	) );
